...
const CONTRACT_ADDRESS = '0x3A6FCAd862Cff00a50B8c03218DFF43C25F70873';
...
async function callLenderData() {
  ...
  if(lenderContractCount > 0) {
    for (var i = 0; i < lenderContractCount; i++) {
      ...
      $('#lender-data-table').append('<div class="row"><div class="cell" data-title="Node Type">' + contractNodeType +'</div><div class="cell" data-title="Lender Split">' + contractLenderSplit + '</div><div class="cell" data-title="Contract Availability">' + contractAvailability + '</div><div class="cell" data-title="Borrower Address">' + contractBorrowerAddress + '</div><div class="cell" data-title="Reset Contract"><button type="button" class="btn btn-warning">Reset</button></div><div class="cell" data-title="Reset Contract"><button type="button" class="btn btn-danger">Remove</button></div></div>');
    }
  } else {
...
async function callBorrowerData() {
  ...
  if(borrowerContractCount > 0) {
    for (var i = 0; i < borrowerContractCount; i++) {
      ...
      console.log("Address: " + contractAddress + " Node Type: " + contractNodeType + " Lender Address: " + contractLenderAddress + " Lender Split: " + contractLenderSplit + " Collateral Amount: " + contractCollateralAmount);
      $('#borrower-data-table').append('<div class="row"><div class="cell" data-title="Node Type">' + contractNodeType +'</div><div class="cell" data-title="Lender Split">' + contractLenderSplit + '</div><div class="cell" data-title="Lender Address">' + contractLenderAddress + '</div><div class="cell" data-title="Reset Contract"><button type="button" class="btn btn-warning">Abandon</button></div></div>');
    }
  } else {
